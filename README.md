...
This Firefox extension allows you to view your Grand Total Marks (client side calculation), select feedback with a single clock in Flex Student portal easily and calculates SGPA (current semester) and updates CGPA. Also, you can toggle dark/light mode and see fees of each semester (without student fees, only courses with credit hours). Contributions and recommendations are welcome.

<p align="center">
  <img width="273" height="408" alt="image" src="https://github.com/user-attachments/assets/e4513911-7de0-4001-8572-be3b6ac24737" />
</p>
...
### Dark Mode
* You can simply click on ```toggle dark/light mode``` button to switch between dark mode and light mode
<p align="center">
  <img width="1908" height="798" alt="image" src="https://github.com/user-attachments/assets/12ac7b72-420c-4261-83ff-53f0a945c62d" />
</p>

### Fees calculator
* Manually searching for course and its credit hours and multiplying with total credits fees and summing the fees of courses is very hectic.
* Now you can simply visit tentative study plan page and click on ```Calculate Fees``` button to check fees of each semester
<p align="center">
  <img width="1908" height="810" alt="image" src="https://github.com/user-attachments/assets/bf3e0967-0fc1-425c-ac01-0a756a3d8d7f" />
</p> 
